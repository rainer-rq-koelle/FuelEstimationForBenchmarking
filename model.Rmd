...
ICAO defined a default LTO cycle consisting of distinct phases: takeoff, climb, approach, and taxi/ground idle.
These phases are characterised with specified thrust levels and times-in-mode.
